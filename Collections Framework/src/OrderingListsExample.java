...
//        Ordem Natural (implementar "Comparable<Gato>" na class Gato
        Collections.sort(gatos);
        System.out.println(gatos);

//        Ordem Idade (implementar "Comparator<Gato>" na nova class ComparatorIdade)
//        Collections.sort(gatos, new ComparatorIdade());
        gatos.sort(new ComparatorIdade());
        System.out.println(gatos);

//        Ordem Cor (implementar "Comparator<Gato>" na nova class ComparatorCor)
